...
const NewsLetter = () => {
    ...
    return(
        <div>
            ...
            <p className="text-md mb-8 font-semibold text-center pb-4">Subcribe to our weekly newsletter and stay updated</p>
            <div className="">
            ...
            <div className="mt-8">
                <button type="button" onClick={handleSubmit} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Subcribe</button>
